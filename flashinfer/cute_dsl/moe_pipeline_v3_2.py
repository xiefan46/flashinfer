...
CuTeDSL DeepSeek FP8 MoE Pipeline v3.2 — GEMM1 FP8 Output Epilogue
=====================================================================

Based on v3. Key difference: GEMM1 directly outputs FP8 + per-128-block
scales from the epilogue, eliminating the separate _quantize_output_fp8()
kernel and its BF16→FP8 memory round-trip.
...
from .moe_grouped_gemm_fp8_v3_2 import (
    moe_gemm1_fp8_v3_2,
    moe_gemm2_fp8_v3_2,
)
...
def cutedsl_fp8_moe_v3_2(
    ...
    gemm2_out_flat = moe_gemm2_fp8_v3_2(
        act_out,
        gemm2_weights,
        act_scale,
        gemm2_weights_scale,
